...
public class MauritiusWeatherParser {

    private static final String ns = null;

    public List<MauritiusWeatherData> parse(InputStream in) throws XmlPullParserException, IOException {
        try {
    ...
    private List<MauritiusWeatherData> readFeed(XmlPullParser parser) throws XmlPullParserException, IOException {
        List<MauritiusWeatherData> entries = new ArrayList<>();
    ...
    private MauritiusWeatherData readItem(XmlPullParser parser, String imageUrl) throws XmlPullParserException, IOException {
        String day = null;
        ...
        return new MauritiusWeatherData(day, weatherCondition, minTemperature, maxTemperature, windDirection,
