 ...
 */
public class Glasgow_2nd_DayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new Glasgow_2nd_DayFragment.FetchGlasgowWeatherTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    private class FetchGlasgowWeatherTask extends AsyncTask<Void, Void, List<GlasgowWeatherData>> {
        ...
        protected void onPostExecute(List<GlasgowWeatherData> weatherDataList) {
            if (weatherDataList != null && !weatherDataList.isEmpty()) {
                GlasgowWeatherData secondDayData = weatherDataList.get(1);
