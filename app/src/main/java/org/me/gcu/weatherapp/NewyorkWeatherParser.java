...
public class NewyorkWeatherParser {

    private static final String ns = null;

    public List<NewyorkWeatherData> parse(InputStream in) throws XmlPullParserException, IOException {
        try {
    ...
    private List<NewyorkWeatherData> readFeed(XmlPullParser parser) throws XmlPullParserException, IOException {
        List<NewyorkWeatherData> entries = new ArrayList<>();
    ...
    private NewyorkWeatherData readItem(XmlPullParser parser, String imageUrl) throws XmlPullParserException, IOException {
        String day = null;
        ...
        return new NewyorkWeatherData(day, weatherCondition, minTemperature, maxTemperature, windDirection,
