...
public class OmanWeatherParser {

    private static final String ns = null;

    public List<OmanWeatherData> parse(InputStream in) throws XmlPullParserException, IOException {
        try {
    ...
    private List<OmanWeatherData> readFeed(XmlPullParser parser) throws XmlPullParserException, IOException {
        List<OmanWeatherData> entries = new ArrayList<>();
    ...
    private OmanWeatherData readItem(XmlPullParser parser, String imageUrl) throws XmlPullParserException, IOException {
        String day = null;
        ...
        return new OmanWeatherData(day, weatherCondition, minTemperature, maxTemperature, windDirection,
