 ...
 */
public class Mauritius_2nd_DayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new Mauritius_2nd_DayFragment.FetchMauritiusWeatherTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    private class FetchMauritiusWeatherTask extends AsyncTask<Void, Void, List<MauritiusWeatherData>> {
        ...
        protected void onPostExecute(List<MauritiusWeatherData> weatherDataList) {
            if (weatherDataList != null && !weatherDataList.isEmpty()) {
               MauritiusWeatherData firstDayData = weatherDataList.get(1);
