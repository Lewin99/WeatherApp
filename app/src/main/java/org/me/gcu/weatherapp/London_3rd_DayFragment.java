 ...
 */
public class London_3rd_DayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new London_3rd_DayFragment.FetchLondonWeatherTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    private class FetchLondonWeatherTask extends AsyncTask<Void, Void, List<LondonWeatherData>> {
        ...
        protected void onPostExecute(List<LondonWeatherData> weatherDataList) {
            if (weatherDataList != null && !weatherDataList.isEmpty()) {
                LondonWeatherData firstDayData = weatherDataList.get(2);
