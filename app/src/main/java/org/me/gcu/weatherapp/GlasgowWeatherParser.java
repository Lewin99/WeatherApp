...
public class GlasgowWeatherParser {
    private static final String ns = null;

    public List<GlasgowWeatherData> parse(InputStream in) throws XmlPullParserException, IOException {
        try {
    ...
    private List<GlasgowWeatherData> readFeed(XmlPullParser parser) throws XmlPullParserException, IOException {
        List<GlasgowWeatherData> entries = new ArrayList<>();
    ...
    private GlasgowWeatherData readItem(XmlPullParser parser, String imageUrl) throws XmlPullParserException, IOException {
        String day = null;
        ...
        return new GlasgowWeatherData(day, weatherCondition, minTemperature, maxTemperature, windDirection,
