 ...
 */
public class Newyork_3rd_DayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new Newyork_3rd_DayFragment.FetchNewYorkWeatherTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    private class FetchNewYorkWeatherTask extends AsyncTask<Void, Void, List<NewyorkWeatherData>> {
        ...
        protected void onPostExecute(List<NewyorkWeatherData> weatherDataList) {
            if (weatherDataList != null && !weatherDataList.isEmpty()) {
                NewyorkWeatherData firstDayData = weatherDataList.get(2);
