...
public class LondonWeatherParser {
    private static final String ns = null;

    public List<LondonWeatherData> parse(InputStream in) throws XmlPullParserException, IOException {
        try {
    ...
    private List<LondonWeatherData> readFeed(XmlPullParser parser) throws XmlPullParserException, IOException {
        List<LondonWeatherData> entries = new ArrayList<>();
    ...
    private LondonWeatherData readItem(XmlPullParser parser, String imageUrl) throws XmlPullParserException, IOException {
        String day = null;
        ...
        return new LondonWeatherData(day, weatherCondition, minTemperature, maxTemperature, windDirection,
