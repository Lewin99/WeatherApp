 ...
 */
public class Oman_3rd_DayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new Oman_3rd_DayFragment.FetchOmanWeatherTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    private class FetchOmanWeatherTask extends AsyncTask<Void, Void, List<OmanWeatherData>> {
        ...
        protected void onPostExecute(List<OmanWeatherData> weatherDataList) {
            if (weatherDataList != null && !weatherDataList.isEmpty()) {
                OmanWeatherData firstDayData = weatherDataList.get(2);
