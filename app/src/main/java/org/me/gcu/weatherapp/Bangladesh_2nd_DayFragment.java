 ...
 */
public class Bangladesh_2nd_DayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new Bangladesh_2nd_DayFragment.FetchBangladeshWeatherTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    private class FetchBangladeshWeatherTask extends AsyncTask<Void, Void, List<BangladeshWeatherData>> {
        ...
        protected void onPostExecute(List<BangladeshWeatherData> weatherDataList) {
            if (weatherDataList != null && !weatherDataList.isEmpty()) {
                BangladeshWeatherData firstDayData = weatherDataList.get(1);
